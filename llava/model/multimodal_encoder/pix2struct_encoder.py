...
from transformers import Pix2StructVisionModel, Pix2StructImageProcessor, Pix2StructVisionConfig
...
class Pix2StructVisionTower(nn.Module):
    def __init__(self, vision_tower, args, delay_load=False):
        ...
        if not delay_load:
            ...
            self.cfg_only = Pix2StructVisionConfig.from_pretrained(self.vision_tower_name)
